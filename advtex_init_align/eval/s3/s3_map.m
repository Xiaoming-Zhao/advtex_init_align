function [s_map1 s_map2 s3] = s3_map(img_f, save_dir, show_res)
...
s_map1_f = fullfile(save_dir, 's_map1.mat');
s_map2_f = fullfile(save_dir, 's_map2.mat');
s3_f = fullfile(save_dir, 's3.mat');

save(s_map1_f, "s_map1", "-v7");
save(s_map2_f, "s_map2", "-v7");
save(s3_f, "s3", "-v7");
